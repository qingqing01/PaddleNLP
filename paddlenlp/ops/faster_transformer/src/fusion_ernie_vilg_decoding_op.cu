...
std::vector<paddle::Tensor> ernie_vilg_decoding_kernel(
  ...
  if ("beam_search" == decoding_strategy) {
    DecodingBeamsearch<DecodingTraits_::OpType>* ernie_vilg_decoding_beam_search_;

    ernie_vilg_decoding_beam_search_ =
        new DecodingBeamsearch<DecodingTraits_::OpType>(
            ...
            false,  /*is_mbart*/
            min_length);
    ernie_vilg_decoding_beam_search_->forward_context(params, decoding_params);
    ernie_vilg_decoding_beam_search_->forward(params, decoding_params);

    delete ernie_vilg_decoding_beam_search_;
    ...
    DecodingSampling<DecodingTraits_::OpType>* ernie_vilg_decoding_sampling_;

    ernie_vilg_decoding_sampling_ = new DecodingSampling<DecodingTraits_::OpType>(
        allocator_,
        batch_size_,
        max_seq_len_,
        head_num_,
        ...
        false,  /*is_mbart*/
        min_length);
    ernie_vilg_decoding_sampling_->forward_context(params, decoding_params);
    ernie_vilg_decoding_sampling_->forward(params, decoding_params);

    delete ernie_vilg_decoding_sampling_;
  } else {
    PD_THROW(
...
std::vector<paddle::Tensor> ErnieVilgDecodingCUDAForward(
  ...
  switch (self_ln_weight[0].type()) {
    case paddle::DataType::FLOAT16: {
      ret = ernie_vilg_decoding_kernel<paddle::DataType::FLOAT16>(
          input_ids,
          attn_mask,
          mem_seq_len,
          type_id,
    ...
    case paddle::DataType::FLOAT32: {
      ret = ernie_vilg_decoding_kernel<paddle::DataType::FLOAT32>(
          input_ids,
          attn_mask,
          mem_seq_len,
          type_id,
